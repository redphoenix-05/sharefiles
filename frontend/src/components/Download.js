...
function Download() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Receive a File</h2>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="0000"
                maxLength="4"
                className="flex-1 text-center text-3xl font-bold tracking-widest border-2 border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition"
              />
            </div>
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
            ...
            <div className="bg-white rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-800 truncate ml-2 max-w-xs">{fileInfo.filename}</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-800">{fileInfo.mimetype}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">Uploaded:</span>
                <span className="font-semibold text-gray-800 text-sm">{formatDate(fileInfo.createdAt)}</span>
              </div>
            </div>
          </div>
